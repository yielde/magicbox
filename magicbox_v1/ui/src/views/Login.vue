<!--
 * @Author: Galen Tong
 * @Date: 2022-08-02 23:44:54
 * @LastEditTime: 2022-08-04 22:01:57
 * @Description: 
-->
<template>
    <div class="main">
        <div class="loginBox">
            <div class="tabBoxSwitch">
                <ul class="tabBoxSwitchUl">
                    <li
                        :class="tabSelected === index ? 'tab-active' : ''"
            ...
            <div v-show="tabSelected === 1">
                <el-form :model="smsForm" :rules="userRules" ref="smsForm">
    ...
    methods: {
        submitForm(formName) {
            ...
            this.$refs[formName].validate((valid) => {
                ...
                this.axiso.post("/base/auth", this.userForm).then((res) => {
                    if (res.data.code === 0) {
